...
[in host browser] Go through OpenMRS web application installation instructions. MySQL database password is set to root_password by default. Choose 'Simple' installation, and install demo data. After everything has been install, log into the OpenMRS webapp with admin/test.
